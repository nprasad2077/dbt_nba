...
```bash
docker exec nba_postgres pg_restore -U nba_admin -d nba_analytics --no-owner --no-acl /Volumes/ROG_BLACK/code/projects/dbt_nba/data/pg_dumps/2025.11.04_nba_backup.dump
```
